...
// Request contains the parameters for the Cron Expression Generator API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"schedule": {Type: "string", Required: true, MaxLength: intPtr(200)},
	}
...
// ResponseData contains the data returned by the Cron Expression Generator API.
