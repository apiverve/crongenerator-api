# Cron Expression Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:crongenerator-api:1.1.14'
}
```
...
```java
import com.apiverve.crongenerator.CronExpressionGeneratorAPIClient;
import com.apiverve.crongenerator.APIResponse;
import com.apiverve.crongenerator.APIException;

// Initialize the client
CronExpressionGeneratorAPIClient client = new CronExpressionGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("schedule", "every weekday at 9am");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/crongenerator](https://docs.apiverve.com/ref/crongenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/crongenerator](https://docs.apiverve.com/ref/crongenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/crongenerator-api/issues)
