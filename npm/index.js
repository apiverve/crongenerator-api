...
class crongeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/crongenerator');
        }
        ...
        this.validationRules = {"schedule":{"type":"string","required":true,"maxLength":200}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/crongenerator`);
        }
    }
...
module.exports = crongeneratorWrapper;
