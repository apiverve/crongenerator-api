...
namespace APIVerve\Crongenerator;
...
/**
 * Client for the Cron Expression Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/crongenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/crongenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CrongeneratorClient] {$message}\n";
        }
    }
}
